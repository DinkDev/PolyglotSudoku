[assembly: System.Runtime.CompilerServices.InternalsVisibleTo(@"SudokuSharp.Engine.Tests")]
namespace SudokuSharp.Engine
{
    ...
    public sealed class Puzzle : INotifyPropertyChanged
    {
        ...
        /// </summary>
        /// <param name="puzzleCoordinate"></param>
        /// <returns></returns>
        ...
        public bool Parse(params string[] puzzleText)
        {
            var sb = new StringBuilder();
            foreach (var rowText in puzzleText)
            {
                sb.Append(rowText);
            }
        ...
        public string ConvertToChar(byte? cell, char nullChar = '.')
        {
