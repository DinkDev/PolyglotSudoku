...
describe('Puzzle constructor', () => {
    ...
    it('args === number declares an uninitialized 9 by 9 board', () => {
        ...
        expect(sut.grid.getValue('r1c1')).to.equal(null);
        expect(sut.grid.getValue('r1c2')).to.equal(null);
        expect(sut.grid.getValue('r5c5')).to.equal(null);
        expect(sut.grid.getValue('r9c9')).to.equal(null);
    });
    ...
    it('args instanceOf Puzzle copies other', () => {
        ...
        expect(sut.puzzleSize).to.equal(PuzzleSize.NineByNine);
        expect(sut.grid.getValue('r1c1')).to.equal('4');
        expect(sut.grid.getValue('r1c2')).to.equal(null);
        expect(sut.grid.getValue('r5c5')).to.equal('3');
        expect(sut.grid.getValue('r9c9')).to.equal('2');
    });
